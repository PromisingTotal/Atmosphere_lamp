...
wire                            de;
wire[15:0]                      vout_data;
wire[15:0]                      vout_data_o;
wire[15:0]                      cmos_16bit_data;
wire[15:0]						cmos_16bit_data_o;
wire                            cmos_16bit_wr;
...
wire		pixel_rgb565_val;
wire[15:0]	pixel_mean;
wire		pixel_mean_val;
wire[23:0]  pixel_data;
wire		pixel_data_vld;
wire		pixel_data_req;
wire[23:0]  ws2812_data;
wire		ws2812_data_vld;
wire		ws2812_data_req;

pixel_taking pixel_taking_m0(
	.rst						(~rst_n					  ),
	.video_clk					(video_clk  			  ),
	.pdata_i					(read_data		          ),

	.pdata_o					(pixel_rgb565             ),
	.data_val					(pixel_rgb565_val		  )
);

pixel_processing pixel_processing_m0(
	.rst						(~rst_n					  ),
	.video_clk					(video_clk  			  ),
	.rgb565_i					(pixel_rgb565	          ),
	.data_valid					(pixel_rgb565_val		  ),
	.pixel_mean					(pixel_mean				  ),
	.odata_val					(pixel_mean_val			  )
);

pixel_mean_ordering pixel_mean_ordering_m0(
	.rst						(~rst_n    		   		  	),
	.video_clk					(video_clk  			          	),
	.pixel_mean					(pixel_mean				  	),
	.pixel_mean_val			    (pixel_mean_val 		  	),
    .rd_req                     (pixel_data_req             ),

    .wr_done                    (		                  	),
	.rgb_o						(pixel_data					),
	.rgb_o_val					(pixel_data_vld				)
);

pixel_2_ws2812 pixel_2_ws2812_m0(
	.clk						(video_clk),
	.rst						(~rst_n),

	.pixel_data					(pixel_data),
	.pixel_data_vld				(pixel_data_vld),
	.pixel_data_req				(pixel_data_req),

	.ws2812_data_req			(ws2812_data_req),
	.ws2812_data				(ws2812_data),
	.ws2812_data_vld			(ws2812_data_vld)
);

WS2812_DRIVER WS2812_DRIVER_m0(
	.clk						(video_clk),
	.rst						(rst_n						),
	.GRB_input					(ws2812_data						),
	.start_flag					(ws2812_data_vld					),

	.end_flag					(ws2812_data_req						),
	.GRB_output					(GRB_output					)
);
